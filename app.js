               ...
               <div onclick="toggleExercise(${i})" style="padding: 12px 15px; display: flex; align-items: center; cursor: pointer; background: ${isOpen ? 'rgba(250, 204, 21, 0.05)' : 'transparent'}; overflow: hidden;">
                ...
                <div style="padding: 0 15px 15px 15px; display: ${isOpen ? 'block' : 'none'}; border-top: 1px solid rgba(255,255,255,0.05);">
                   ...
                   <div style="display:flex; gap:8px; margin-top:12px;">
                      ...
                      <button style="flex:2; padding:12px; background:${isDone ? 'rgba(148,163,184,0.25)' : 'linear-gradient(135deg,#15803d,#22c55e)'}; color:#fff; border-radius:12px; font-size:13px; font-weight:800; border:${isDone ? '1px solid rgba(148,163,184,0.2)' : 'none'}; cursor:pointer; display:flex; align-items:center; justify-content:center; gap:6px;" onclick="toggleExerciseDone(${i})">
...
function updateSingleExerciseCard(exIdx) {
    ...
    targetCard.innerHTML = `
        ...
        <div onclick="toggleExercise(${exIdx})" style="padding: 12px 15px; display: flex; align-items: center; cursor: pointer; background: ${isOpen ? 'rgba(250, 204, 21, 0.05)' : 'transparent'}">
            ...
            <div style="display: flex; align-items: center; gap: 6px; flex-shrink: 0; margin-left: 6px; overflow-x: auto; scrollbar-width: none; -webkit-overflow-scrolling: touch;">
               <button onclick="event.stopPropagation(); toggleExerciseNote(${exIdx})" style="background:#1e2d3d;border:1px solid #2a3d52;color:#94a3b8;border-radius:20px;padding:4px 8px;font-size:11px;font-weight:700;display:flex;align-items:center;gap:4px;position:relative;">
                        ...
                        <button onclick="event.stopPropagation(); openReplaceExerciseModal(${exIdx})" style="background:#1a3040;border:1px solid #22d3ee;color:#22d3ee;border-radius:20px;padding:4px 8px;font-size:11px;font-weight:700;display:flex;align-items:center;gap:4px;" ${isDone ? 'disabled' : ''}>
                        ...
                        <button onclick="event.stopPropagation(); removeActiveExercise(${exIdx})" style="background:#2d1a1a;border:1px solid #7f1d1d;color:#ef4444;border-radius:20px;padding:4px 8px;font-size:11px;font-weight:700;display:flex;align-items:center;justify-content:center;" ${isDone ? 'disabled' : ''}>
        ...
        <div style="padding: 0 15px 15px 15px; display: ${isOpen ? 'block' : 'none'}; border-top: 1px solid rgba(255,255,255,0.05);">
            ...
            <div style="display:flex; gap:8px; margin-top:12px;">
                      ...
                      <button style="flex:2; padding:12px; background:${isDone ? 'rgba(148,163,184,0.25)' : 'linear-gradient(135deg,#15803d,#22c55e)'}; color:#fff; border-radius:12px; font-size:13px; font-weight:800; border:${isDone ? '1px solid rgba(148,163,184,0.2)' : 'none'}; cursor:pointer; display:flex; align-items:center; justify-content:center; gap:6px;" onclick="toggleExerciseDone(${exIdx})">
                        <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">${isDone ? '<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>' : '<circle cx="12" cy="12" r="10"></circle><polyline points="9 12 11 14 15 10"></polyline>'}</svg>
                        ${isDone ? 'Undo' : 'Finish exercise'}
                      </button>
                    </div>
