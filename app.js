            ...
            if (exerciseData.sets_data) {
                exerciseData.sets_data.forEach((set, sIdx) => {
                    ...
                    <div style="display:grid; grid-template-columns: 40px 1fr 1fr 1fr 30px; gap:8px; margin-bottom:8px; align-items:center;">
                       ...
                       <button onclick="removeSetFromExercise(${i}, ${sIdx})" style="background:none; border:none; color:var(--danger); font-size:16px; opacity: ${showSuccess ? '0.1' : '0.4'};" ${showSuccess ? 'disabled' : ''}>×</button>
                    </div>`;
    ...
    if (exerciseData.sets_data) {
        exerciseData.sets_data.forEach((set, sIdx) => {
            ...
            <div style="display:grid; grid-template-columns: 40px 1fr 1fr 1fr 30px; gap:8px; margin-bottom:8px; align-items:center;">
               ...
               <button onclick="removeSetFromExercise(${exIdx}, ${sIdx})" style="background:none; border:none; color:var(--danger); font-size:16px; opacity: ${showSuccess ? '0.1' : '0.4'};" ${showSuccess ? 'disabled' : ''}>×</button>
            </div>`;
            if (isCurrent) {
                setsHtml += `
                <div style="grid-column: 2 / span 3; margin:-4px 0 8px 0; padding-left:2px; opacity:0.8; font-size:10px; color:var(--primary); font-weight:600; letter-spacing:0.3px;">
